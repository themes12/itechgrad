        ...
        <>
            <section className=" relative  xl:pt-4 mb-20 md:pt-8 lg:pt-10 md:pb-8 lg:pb-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-9 lg:px-9 flex xxxs:flex-col lg:flex-row ">
                <div className="z-0 xxxs:block lg:hidden mt-4 mb-4 md:ml-8 md:mr-8">
                    <img className="mx-auto object-fill rounded-md " src="/_DSC3640.jpg " alt="" />
                </div>
                ...
                <div className="z-0 -ml-80 xxxs:hidden lg:block">
                    <img className="mx-auto object-fill lg:mr-[45rem] rounded-md" src="/_DSC3640.jpg" alt="" />
                </div>
            </section>
            ...
            <section className=" relative pt-4 mb-40 md:pt-8 lg:pt-10 md:pb-8 lg:pb-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-9 lg:px-9 flex xxxs:flex-col lg:flex-row ">
                ...
                <div className="z-0 xxxs:hidden lg:block mb-4">
                    <img className="mx-auto object-fill lg:mr-[43rem] rounded-md" src="/_DSC3484.jpg" alt="" />
                </div>

                <div className="z-0 xxxs:block lg:hidden mb-4 md:ml-8 md:mr-8">
                    <img className="mx-auto object-fill lg:mr-[45rem] rounded-md" src="/_DSC3484.jpg" alt="" />
                </div>
