...
<<<<<<< Updated upstream:app/[locale]/(non-admin)/program/master-degree/page.tsx
import {Button, ButtonGroup} from "@nextui-org/react";
=======
import { Button, ButtonGroup } from "@nextui-org/react";
import degreeJson from '@/utils/degree.json'
import { Degree } from '@/types/course';
>>>>>>> Stashed changes:app/[locale]/(non-admin)/program/[degree]/page.tsx
      ...
      <div>
        <section className="bg-whaite py-12 pt-0 relative">
          ...
          <header className="pt-4 md:pt-8 lg:pt-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-9 lg:px-9 relative">
            <h1 className="text-[64px] font-bold">Master's Degree Program</h1>
            <h5 className="text-[25px] font-[300] text-[#7D7D7D] pt-5">Master of Science Program in Computer Science</h5> 
=======
  ...
  return (
    <div>
      <section className="bg-whaite py-12 pt-0 relative">
        <section className="bg-gradient-to-r from-[#d1e0d8] to-[#76b9cd] py-12 max-w-screen-2xl max-h-300px relative">
          <header className="pt-4 md:pt-8 lg:pt-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-9 lg:px-9 relative">
            <h1 className="text-[64px] font-bold">{degreeText} Program</h1>
            <h5 className="text-[25px] font-[300] text-[#7D7D7D] pt-5">Master of Science Program in Computer Science</h5>
>>>>>>> Stashed changes:app/[locale]/(non-admin)/program/[degree]/page.tsx
          </header>
          </section>
