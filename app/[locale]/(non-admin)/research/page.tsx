        ...
        <>
            <section className="pt-4 mb-8 md:pt-8 lg:pt-10 md:pb-8 lg:pb-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-9 lg:px-9">
                <div className="space-y-4">
                    <h2 className="flex justify-start font-bold text-2xl xxs:text-5xl xs:text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-[64px] text-[#0A76DB] mx-8 mt-8">
                        Research&nbsp;
                        <span className="flex text-[#000000] ">
                            at&nbsp;the
                        </span>
                    </h2>

                    <h2 className="flex justify-start font-bold text-2xl xxs:text-5xl xs:text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-[64px]  text-[#000000] mx-8 mt-8">
                        Computer Science CMU
                    </h2>
                </div>

                <p className="flex justify-start font-normal text-md xxs:text-md xs:text-md sm:text-md md:text-xl lg:text-xl xl:text-xl text-[#000000] mx-8 mt-8">
            ...
            <section>
                ...
                <div className="relative flex flex-row bg-[#262626] px-10 pt-24 pb-10 xxxs:flex-col xxs:flex-col xs:flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row ">
                    <div
                        id="image"
                        className="mx-auto my-auto xxxs:flex xxs:flex sm:flex md:hidden"
                    >
                        <img
                            className=" object-scale-down w-max xxxs:h-40 xxs:h-60 xs:h-60 sm:h-60 md:h-72 lg:h-72  xl:h-96  "
                            src="/_DSC4254.jpg"
                            alt=""
                        />
                    </div>
                    <div
                        id="image"
                        className="my-11 mr-10 ml-auto xxxs:hidden xxs:hidden sm:hidden md:flex"
                    >
                        <img
                            className=" object-scale-down w-max xxxs:h-40 xxs:h-60 xs:h-60 sm:h-60 md:h-72 lg:h-72  xl:h-96  "
                            src="/_DSC4254.jpg"
                    ...
                    <div className=" font-semibold text-[#E7F6FD] text-xl xxs:text-2xl xs:text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-10 mb-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto">
                        Medical informatics
                        ...
                        <br />
                        <button className="xxxs:text-xs xxs:text-xs xs:text-xs sm:text-xs md:text-sm lg:text-base font-normal transition-all ease-in-out hover:bg-[#E7F6FD] hover:text-[#262626] hover:px-3 rounded-md py-1 text-left">
                        ...
                        <div className=" font-semibold text-[#E7F6FD] text-xl xxs:text-2xl xs:text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto ">
                            ...
                            <br />
                            <button className="text-sm xxxs:text-xs xxs:text-xs xs:text-xs sm:text-xs md:text-sm lg:text-base font-normal  transition-all ease-in-out hover:bg-[#E7F6FD] hover:text-[#262626] hover:px-3 rounded-md py-1 text-left ">
                                Churee&nbsp;Techawut, Worawut&nbsp;Srisukkham,
                                Suphakit&nbsp;Awipan, Jakarin&nbsp;Chawachat
                            </button>
                            <hr className="h-px mt-3 bg-[#3B3B3B] border-0" />
                ...
                <div className=" relative flex flex-row bg-[#ffffff] px-10 pt-14 pb-14 xxxs:flex-col xxs:flex-col xs:flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row ">
                    <div
                        id="image"
                        className="my-auto mx-auto xxxs:flex xxs:flex sm:flex md:hidden"
                    >
                        <img
                    ...
                    <div className=" font-semibold text-[#262626] text-xl xxs:text-2xl xs:text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-10 mb-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto">
                        ...
                        <br />
                        <button className="text-sm xxxs:text-xs xxs:text-xs xs:text-xs sm:text-xs md:text-sm lg:text-base font-normal mt-7 bg-transparent border border-[#F3F3F3] rounded-md py-1 px-3 ">
                            Reseacher
                        </button>
                        <br />
                        <button className="text-sm xxxs:text-xs xxs:text-xs xs:text-xs sm:text-xs md:text-sm lg:text-base font-normal transition-all ease-in-out  hover:bg-[#262626] hover:text-[#E7F6FD] hover:px-3 rounded-md py-1 text-left">
                            Suphakit&nbsp;Awipan
                        </button>
                    ...
                    <div
                        id="image"
                        className="my-11 mr-auto ml-2 xxxs:hidden xxs:hidden sm:hidden md:flex"
                    >
                        <img
                ...
                <div className="relative flex flex-row bg-[#262626] px-10 pt-14 pb-14 xxxs:flex-col xxs:flex-col xs:flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row">
                    ...
                    <div
                        id="image"
                        className="my-11 ml-auto mr-10 xxxs:hidden xxs:hidden sm:hidden md:flex"
                    >
                        <img
                            className=" object-scale-down h-96 w-192 xxxs:h-40 xxs:h-60 xs:h-60 sm:h-60  md:h-72 lg:h-72  xl:h-96"
                            src="/_DSC4197.jpg"
                ...
                <div className=" relative flex flex-row bg-[#ffffff] px-10 pt-14 pb-14 xxxs:flex-col xxs:flex-col xs:flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row ">
                    ...
                    <div
                        id="image"
                        className="my-11 mr-auto ml-10 xxxs:hidden xxs:hidden sm:hidden md:flex"
                    >
                        <img
                            className=" object-scale-down h-96 w-192 xxxs:h-40 xxs:h-60 xs:h-60 sm:h-60  md:h-72 lg:h-72  xl:h-96"
                            src="/_DSC4704.jpg"
