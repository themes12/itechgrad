    ...
    <>
      <section className="pt-4 mb-8 md:pt-8 lg:pt-10 md:pb-8 lg:pb-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto px-9 lg:px-9">
        <div className="space-y-4">
          <h2 className="flex justify-start font-bold text-2xl xxs:text-5xl xs:text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-6xl text-[#0A76DB] mx-8 mt-8">
            Research
            <span className="flex justify-start font-bold text-2xl xxs:text-5xl xs:text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-6xl text-[#000000] mx-3">
              at the
            </span>
          </h2>

          <h2 className="flex justify-start font-bold text-2xl xxs:text-5xl xs:text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-6xl text-[#000000] mx-8 mt-8" >
            Computer Science CMU
          </h2>
        </div>

        <p className="flex justify-start font-normal text-md xxs:text-md xs:text-md sm:text-md md:text-l lg:text-l xl:text-l text-[#000000] mx-8 mt-8">
      ...
      <section >
        ...
        <div className="relative flex flex-row bg-[#262626] px-10 pt-24 pb-10 xxxs:flex-col xxs:flex-col xs:flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row">
          ...
          <div className=" font-semibold text-[#E7F6FD] text-xl xxs:text-2xl xs:text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl mt-10 mb-10 md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto">
            ...
            <button className="text-xs font-normal mt-7 bg-transparent border border-white rounded-md py-1 px-3 ">
              Reseacher
            </button>
            <br />
