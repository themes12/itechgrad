...
const Form = ({ course, params }: Props) => {
    ...
    const formik = useFormik<Course>({
        ...
        validationSchema: Yup.object({
            ...
            credit: Yup.object({
                ...
                independent_study: Yup.number().required("Required"),
            }),
            description_en: Yup.string().required("Required"),
            description_th: Yup.string().required("Required"),
        }),
    ...
    const isFormFieldInvalid = (name: string) =>
        !!(
            formik.touched[name as keyof Course] &&
            formik.errors[name as keyof Course]
        );
            ...
            <div className="grid grid-cols-4 gap-3">
                <div className="h-unit-10 min-h-unit-10">
                    <Input
                        ...
                        errorMessage={
                            isFormFieldInvalid("_id") && formik.errors._id
                        }
                        className="max-w-xs"
            ...
            <div className="grid grid-cols-4 gap-3">
                <div>
                    <Input
                        ...
                        errorMessage={
                            isFormFieldInvalid("credit.total") &&
                            formik.errors.credit?.total
                        }
                        className="max-w-xs"
                ...
                <div>
                    <Input
                        ...
                        errorMessage={
                            isFormFieldInvalid("credit.lecture") &&
                            formik.errors.credit?.lecture
                        }
                        className="max-w-xs"
                ...
                <div>
                    <Input
                        ...
                        errorMessage={
                            isFormFieldInvalid("credit.lab") &&
                            formik.errors.credit?.lab
                        }
                        className="max-w-xs"
                ...
                <div>
                    <Input
                        ...
                        isInvalid={isFormFieldInvalid(
                            "credit.independent_study"
                        )}
                        errorMessage={
                            isFormFieldInvalid("credit.independent_study") &&
                            formik.errors.credit?.independent_study
                        }
                        className="max-w-xs"
            ...
            <div className="grid grid-cols-2 gap-3">
                <div>
                    <Textarea
                        ...
                        errorMessage={
                            isFormFieldInvalid("description_en") &&
                ...
                <div>
                    <Textarea
                        ...
                        errorMessage={
                            isFormFieldInvalid("description_th") &&
                            formik.errors.description_th
                        }
                        className="w-full"
